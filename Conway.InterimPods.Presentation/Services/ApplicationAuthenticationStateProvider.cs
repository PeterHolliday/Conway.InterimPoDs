...
using Conway.InterimPods.Presentation.Models;

namespace Conway.InterimPods.Presentation
{
    public class ApplicationAuthenticationStateProvider : AuthenticationStateProvider, IHostEnvironmentAuthenticationStateProvider
    {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            else
            {
                ...
                {
                    identity = new ClaimsIdentity(state.Claims.Select(c => new Claim(c.Type, c.Value)), "Conway.InterimPods.Presentation");
                }
